...
namespace REST_API
{
    ...
    public partial class Vasarlas
    {
        public static Vasarlas[] FromJson(string json) => JsonConvert.DeserializeObject<Vasarlas[]>(json, REST_API.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Vasarlas[] self) => JsonConvert.SerializeObject(self, REST_API.Converter.Settings);
    }
